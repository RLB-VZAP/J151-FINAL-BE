...
<%--
  players.jsp — Player browsing page (W2-T02B)
  Populated by the future PlayerServlet (W2-T02A).
  Expected request attributes: players, clubs, positions,
  searchTerm, selectedClubId, selectedPositionId, errorMessage
--%>
<!DOCTYPE html>
<html>
<head>
